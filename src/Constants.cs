...
public static class Constants
{
    ...
    public const string TimeSetCommand = "/time";
    ...
    public static ReadOnlyDictionary<string, string> HelpStrings { get; } = new(new Dictionary<string, string>
    {
        ...
        { TimeSetCommand, $"Use this to tell Vasily your current time <b>HOUR</b>. He'll use it to calculate your timezone so your receive your wake up at your correct {Constants.UpdateHour} o'clock time." },
